        ...
        public System.Data.DataTable ThreadReadExcel(string excelFilePath)
        {
            ...
            try
            {
                ...
                if (worksheet == null)
                    return null;
                string cellContent;
                int iRowCount = worksheet.UsedRange.Rows.Count;//获取总行数
                int iColCount = worksheet.UsedRange.Columns.Count;//获取总列数
                Microsoft.Office.Interop.Excel.Range range;
                //负责列头Start
                DataColumn dc;
                int ColumnID = 1;
...
System.GC.Collect();
        ...
        /// <param name="excelFilePath">路径</param>
        /// <returns>DataTabel</returns>
        public System.Data.DataTable ThreadReadExcel(string excelFilePath,string sheetName)
        {
            Microsoft.Office.Interop.Excel.Application app = new Microsoft.Office.Interop.Excel.Application();
            Microsoft.Office.Interop.Excel.Sheets sheets = null;
            Microsoft.Office.Interop.Excel.Workbook workbook = null;
            ...
            try
            {
                ...
                //将数据读入到DataTable中——Start   
                sheets = workbook.Worksheets;
                Microsoft.Office.Interop.Excel.Worksheet worksheet = workbook.Worksheets[sheetName];//读取指定表名
                //Microsoft.Office.Interop.Excel.Worksheet worksheet = (Microsoft.Office.Interop.Excel.Worksheet)sheets.get_Item(1);//读取第一张表
                if (worksheet == null)
                    return null;
                string cellContent;
